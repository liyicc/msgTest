...
static void __CPTR_Initialize_Properties(void)
{
    ...
    cpptestAddProperty("testlog.file", "C:\\Users\\ruiking\\Documents\\Visual Studio 2010\\Projects\\Calculator\\.cpptest\\Calculator\\unit-data\\current_tubf179707/cpptest_results.tlog");
    cpptestAddProperty("testlog.append", "true");
    cpptestAddProperty("covlog.enabled", "true");
    cpptestAddProperty("covlog.file", "C:\\Users\\ruiking\\Documents\\Visual Studio 2010\\Projects\\Calculator\\.cpptest\\Calculator\\unit-data\\current_tubf179707/cpptest_results.clog");
...
EXTERN_C_LINKAGE void TestSuite_Calculator_cpp_a3ed44a1_testSuiteBegin(void);
EXTERN_C_LINKAGE int TestSuite_Calculator_cpp_a3ed44a1_callTest(const char*);

static void __CPTR_Do_Tests_TestSuite_Calculator_cpp_a3ed44a1()
{
    CPPTEST_RUN_TEST_SUITE_BEGIN(TestSuite_Calculator_cpp_a3ed44a1, "Calculator/Calculator/\346\272\220\346\226\207\344\273\266/Calculator.cpp", 50)
        CPPTEST_RUN_TEST_SUITE_SETUP(TestSuite_Calculator_cpp_a3ed44a1)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_add_1)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_add_10)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_add_2)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_add_3)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_add_4)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_add_5)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_add_6)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_add_7)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_add_8)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_add_9)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_divide_1)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_divide_10)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_divide_2)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_divide_3)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_divide_4)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_divide_5)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_divide_6)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_divide_7)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_divide_8)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_divide_9)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_minus_1)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_minus_10)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_minus_2)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_minus_3)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_minus_4)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_minus_5)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_minus_6)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_minus_7)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_minus_8)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_minus_9)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_multiply_1)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_multiply_10)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_multiply_2)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_multiply_3)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_multiply_4)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_multiply_5)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_multiply_6)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_multiply_7)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_multiply_8)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_multiply_9)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_wmain_1)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_wmain_10)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_wmain_2)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_wmain_3)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_wmain_4)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_wmain_5)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_wmain_6)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_wmain_7)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_wmain_8)
        CPPTEST_RUN_TEST_CASE(TestSuite_Calculator_cpp_a3ed44a1, test_wmain_9)
        CPPTEST_RUN_TEST_SUITE_TEARDOWN(TestSuite_Calculator_cpp_a3ed44a1)
    CPPTEST_RUN_TEST_SUITE_END(TestSuite_Calculator_cpp_a3ed44a1, 50)
}
...
static void __CPTR_Do_Tests(void)
{
    ...
    __CPTR_Do_Tests_TestSuite_Calculator_cpp_a3ed44a1();
