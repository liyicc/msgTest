...
namespace TestProject1
{
    ...
    public class ProgramTest
    {
        ...
        public void AddTest()
        {
            ...
            int a = 127; // TODO: 初始化为适当的值
            int b = 20; // TODO: 初始化为适当的值
            int expected = 147; // TODO: 初始化为适当的值
            int actual;
        ...
        {
            Program target = new Program(); // TODO: 初始化为适当的值
            int a = 45; // TODO: 初始化为适当的值
            int b = 9; // TODO: 初始化为适当的值
